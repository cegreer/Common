...
namespace Vizistata {
	/// <summary>
	/// This is a test class for <see cref="T:ServerServiceException"/> and is intended to contain all <see cref="T:ServerServiceException"/> Unit Tests.
	///</summary>
	[TestClass()]
	public class ServerServiceExceptionTests {
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:ServerServiceExceptionTests"/> class.
		/// </summary>
		public ServerServiceExceptionTests() : base() { }
	...
	// Constructor Tests
		...
		public void ServerServiceException_Unit_Constructor1_Optimal() {
			new ServerServiceException();
		}
		[TestMethod()]
		[Description(".ctor(String) constructor for the optimal path.")]
		public void ServerServiceException_Unit_Constructor2_Optimal() {
			String message = "This is a test.";
			new ServerServiceException(message);
		}
		[TestMethod()]
		[Description(".ctor(String) constructor when message is a null reference.")]
		public void ServerServiceException_Unit_Constructor2_MessageNull() {
			String message = null;
			new ServerServiceException(message);
		}
		[TestMethod()]
		[Description(".ctor(String, Exception) constructor for the optimal path.")]
		public void ServerServiceException_Unit_Constructor3_Optimal() {
			String message = "This is a test.";
			Exception innerException = new ApplicationException("This is a test.").AsThrown();
			new ServerServiceException(message, innerException);
		}
		[TestMethod()]
		[Description(".ctor(String, Exception) constructor when message is a null reference.")]
		public void ServerServiceException_Unit_Constructor3_MessageNull() {
			String message = null;
			Exception innerException = new ApplicationException("This is a test.").AsThrown();
			new ServerServiceException(message, innerException);
		}
		...
		public void ServerServiceException_Unit_Constructor3_InnerExceptionNull() {
			String message = "This is a test.";
		...
		public void ServerServiceException_Unit_Constructor4_InfoNull() {
			SerializationInfo info = null;
			StreamingContext context = new StreamingContext();
			new ExceptionFactory<ServerServiceException>().CreateInstance(info, context);
		}

	// Serialization Tests
		[TestMethod()]
		[Description("Serializability of the class for the optimal path.")]
		public void ServerServiceException_Integration_Serialization_Optimal() {
			String message = "This is a test.";
			Exception innerException = new ApplicationException("This is a test.").AsThrown();
			ServerServiceException original = new ServerServiceException(message, innerException);

			ServerServiceException clone = original.SerializeBinary();
